...
export const CertificatesSection: React.FC = () => {
  ...
  return (
    <>
      <section
        id="certificates"
        className="py-24 px-4 bg-secondary/30 light-mode:bg-gray-50 terminal-mode:bg-emerald-950/20"
      >
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className="absolute top-3 right-3 bg-accent/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs text-accent-light border border-accent/40 light-mode:bg-blue-600/20 light-mode:text-blue-600 light-mode:border-blue-400 terminal-mode:bg-emerald-600/20 terminal-mode:text-emerald-300 terminal-mode:border-emerald-500"
                      >
                        Click to view
                      </motion.div>
                    </motion.div>
      ...
      <AnimatePresence>
        {selectedCertificate && (
          <>
            ...
            >
              <div
                className="bg-primary rounded-lg shadow-2xl max-w-2xl mx-auto light-mode:bg-white terminal-mode:bg-emerald-950"
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <motion.img
                    ...
                    className="w-full h-96 object-cover rounded-lg mb-6 light-mode:border light-mode:border-gray-200"
                  />
