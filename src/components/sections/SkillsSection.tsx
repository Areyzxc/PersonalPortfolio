    ...
    categories = [
        ...
        skills: [
            ...
            { name: 'PostgreSQL', level: 48, category: 'backend', icon: 'postgresql' },
            { name: 'MySQL', level: 70, category: 'backend', icon: 'mysql' },
            { name: 'MongoDB', level: 50, category: 'backend', icon: 'mongodb' },
        ...
        skills: [
            ...
            { name: 'Git', level: 70, category: 'tools', icon: 'gitbranch' },
